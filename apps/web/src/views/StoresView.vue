...
<template>
  <section v-loading="loading" class="page-stack gap-page">
    <div class="page-toolbar"><el-button :loading="loading" @click="reload">刷新</el-button><el-button v-if="canManageMerchants" type="primary" @click="openCreate">新建门店</el-button></div>
