...
export function readBargainMetrics(
  ...
  const startTime = rowDateText(
    ...
    [
      ...
      'startDate',
      'start_date',
      'bargainCommodityDynamic.startTime',
      'bargainCommodityDynamic.start_time',
      'bargainCommodityDynamic.startDate',
      'bargainCommodityDynamic.start_date',
      'beginTime',
      'begin_time',
      'createDate',
      'createdAt'
  ...
  const endTime = rowDateText(
    ...
    [
      ...
      'expireDate',
      'expire_date',
      'bargainCommodityDynamic.endTime',
      'bargainCommodityDynamic.end_time',
      'bargainCommodityDynamic.endDate',
      'bargainCommodityDynamic.end_date',
      'finishTime',
      'finish_time',
      'expireTime',
      'expire_time'
