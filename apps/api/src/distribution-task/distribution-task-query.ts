...
// Compatibility facade: keep the historic task-query entry point stable while
// the TaskPerformanceDaily read responsibilities live in their own module.
export { getTaskKpi, getTaskPerformance } from './distribution-task-performance-query';
