...
function assertNotDefault(envValue: string | undefined, defaultValue: string, varName: string): string {
...
export const JWT_SECRET = assertNotDefault(process.env.JWT_SECRET, DEFAULT_JWT_SECRET, 'JWT_SECRET');
export const JWT_EXPIRES_IN = '24h';
export const ADMIN_USERNAME = process.env.AUTH_USERNAME || 'admin';
export const ADMIN_PASSWORD = assertNotDefault(process.env.AUTH_PASSWORD, DEFAULT_ADMIN_PASSWORD, 'AUTH_PASSWORD');
